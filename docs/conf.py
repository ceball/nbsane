# -*- coding: utf-8 -*-
#
# pytest-nbsane documentation build configuration file, created by
...
project = u'pytest-nbsane'
copyright = u'2015, IOAM'
author = u'IOAM'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-nbsane Documentation',
     [author], 1)
]
